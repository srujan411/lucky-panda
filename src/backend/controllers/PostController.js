...
export const likePostHandler = function (schema, request) {
  ...
  try {
    ...
    const { _id, fullName,  username, createdAt, updatedAt, followers, following } = user;
    const postId = request.params.postId;
    const post = schema.posts.findBy({ _id: postId }).attrs;
    ...
    post.likes.likedBy.push({ _id, fullName,  username, createdAt, updatedAt, followers, following });
